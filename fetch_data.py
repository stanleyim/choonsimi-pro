"""
fetch_data.py — v4.9 OHL ENRICH ADDED
─────────────────────────────────────────────
✔ v4.8.2 모든 기능 유지 (기존 함수 변경 없음)
✔ NEW: volume_rank 결과를 inquire-price 로 OHL 보강
✔ NEW: ThreadPoolExecutor 병렬 처리 (workers=4)
✔ graceful degradation (실패해도 시스템 유지)
─────────────────────────────────────────────
"""
...
# ═══════════════════════════════════════════════════════
# NEW v4.9 — OHL ENRICH (병렬, graceful)
...
def main():
    ...
    rank_rows = enrich_ohl(token, rank_rows)   # ← NEW v4.9: OHL 보강
